...
1\.	Select whether you would like to receive the edge sequence, corner

 	sequence, or both (including parity).



2\.	Input your scramble, or if you want a random scramble leave the
